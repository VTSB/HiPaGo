...
const NAV = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="m11.48 3.5 2.13 5.11a.56.56 0 0 0 .47.34l5.52.45c.5.04.7.66.32.99l-4.2 3.6a.56.56 0 0 0-.18.55l1.29 5.39a.56.56 0 0 1-.84.6l-4.73-2.88a.56.56 0 0 0-.58 0l-4.73 2.88a.56.56 0 0 1-.84-.6l1.29-5.39a.56.56 0 0 0-.18-.55l-4.2-3.6c-.38-.33-.18-.95.32-.99l5.52-.45a.56.56 0 0 0 .47-.34l2.13-5.11a.56.56 0 0 1 1.04 0z"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
      </svg>
    ...
    <>
      ...
      >
        <div className="mx-auto flex min-h-16 max-w-7xl items-center gap-3 px-4 py-2 md:min-h-14 md:gap-4">
          ...
          <Link
            href="/"
            className="hidden text-lg font-bold tracking-tight text-zinc-900 md:block dark:text-zinc-100"
          >
            HiPaGo
          </Link>
